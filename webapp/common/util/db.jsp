	    ...
	    <tr>
		  <td colspan="2">
		    <form action="db.jsp">
			  ...
			  <label>url:<input type="text" name="url" value="jdbc:mysql://localhost:3306/lemon?useUnicode=true&amp;characterEncoding=utf-8&amp;useSSL=false&allowMultiQueries=true"></label>
			  <label>username:<input type="text" name="username" value="root"></label>
			  <label>password:<input type="text" name="password" value="cfl,1997"></label>
