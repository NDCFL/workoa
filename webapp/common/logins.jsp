    ...
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="${tenantPrefix}">
                <img src="${cdnPrefix}/public/mossle/0.0.11/logo32.png" class="img-responsive pull-left"
                ...
                <div class="panel-body">
                    ...
                    <form id="userForm" name="f" method="post" action="${tenantPrefix}/j_spring_security_check"
                        ...
                        <div class="form-group" style="display:none">
                            ...
                            <div class="col-md-10">
                                <input type="text" value="${tenantPrefix}">
                                ...
                                <span id="tenantText" class="glyphicon glyphicon-remove form-control-feedback"
                                      aria-hidden="true"
                                      style="right:15px;cursor:pointer;pointer-events:auto;display:none;"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="username"><spring:message
                            ...
                            <div class="col-md-10">
                                ...
                                <span id="usernameText" class="glyphicon glyphicon-remove form-control-feedback"
                                      aria-hidden="true"
                                      style="right:15px;cursor:pointer;pointer-events:auto;display:none;"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="password"><spring:message
                        ...
                        <c:if test="${sessionScope['captchaSessionToken']}">
                            <div class="form-group" id="captchaArea">
                                ...
                                <div class="col-md-2">
                                    <img id="captchaPicture" src="captcha.jsp?_=<%=System.currentTimeMillis()%>"
